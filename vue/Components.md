...
یک کامپوننت می‌تواند از اجزاء مختلفی تشکیل شده باشد. وقتی یک کامپوننت اسلات‌های مختلفی دارد یعنی اجزاء مختلفی دارد. حال اگر این یک کامپوننت را در سمت والد صدا بزنیم، با 
